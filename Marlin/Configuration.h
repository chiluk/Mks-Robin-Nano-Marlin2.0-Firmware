...
#define STRING_CONFIG_H_AUTHOR "(chiluk, SapphirePlusv2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "TwoTrees Sapphire Plus v2, belted, one z-limit, 3x2208 + 2x2225"
